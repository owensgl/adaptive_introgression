...
library(grid)
library(gridExtra)
out3 <- read_tsv("Documents/adaptive_introgression/example_sim_dec12_delta1_out3.txt",
                 col_names = c("spacer","version","type", "gen","pop","mut_pos",
                               "mut_popID","mut_freq","mut_sel")) %>%
  filter(gen > 1)

out2 <- read_tsv("Documents/adaptive_introgression/example_sim_dec12_delta1_out2.txt",
...
pdf("Documents/adaptive_introgression/example_sim_delta1.plots.v1.pdf",width=15,height=8)
